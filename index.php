...
<div class="divBackGround">
    ...
    <div>
        ...
        <br>
        <div class="parrafo">Busca gratis toda la información de empresas <br> nacionales</div>

        <form action="app/buscador" method="POST">
    ...
    <form action="app/buscarid" method="POST" name="formBusqueda">
        <input type="text" id="buscadorEmpresa" name="buscadorEmpresa" hidden>
    </form>
        ...
        <div class="grid-container2">
            <?php foreach($Top5 as $Empresas){ ?>
                ...
                <?php 
                    ...
                    <br>
                    <button onclick="BuscarEmpresa('<?php echo $Nombreempresa ?>')" class="BotonViculo">
                        <?php echo mb_convert_case($Nombreempresa, MB_CASE_TITLE, "UTF-8"); ?>
                    </button>
                    <!--
                    <a href="" onclick="BuscarEmpresa('<?php echo $Nombreempresa ?>"')" class="parrafo1">
                        <?php echo mb_convert_case($Nombreempresa, MB_CASE_TITLE, "UTF-8"); ?>
                    </a>-->
                    <br>
...
<script>
    //href="buscarid?buscador=<?php echo $Nombreempresa ?>"
    function BuscarEmpresa(NombreEmpresa){
        document.getElementById("buscadorEmpresa").value = NombreEmpresa;
