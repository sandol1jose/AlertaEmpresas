    ...
    foreach($Array_Nivel1 as $Clave => $Valor){
        switch($Clave){
            ...
            case "Primera sucursal de sociedad extranjera":
                ...
                break;
            case "Nombramientos":
                //Nombramientos($Datos_Registrales, $Valor, "Nombramientos", "entidad", "tipo_directivo");
            ...
            case "Ceses/Dimisiones":
                //Nombramientos($Datos_Registrales, $Valor, "Declaracion_unipersonal", "entidad", "tipo_directivo");
...
function Cese_Dimision_Update($Directivo, $Fecha_Cese, $ArrayCompleto){
    ...
    $IndiceArray = indexOfArray($Directivo, 'Directivos.datos.entidad');
    if(!($IndiceArray === -1 || $IndiceArray === NULL)){
...
function CambioDenominacionSocial($Valor, $String){
    ...
    $nombre_comercial = Trimear($nombre_comercial);
